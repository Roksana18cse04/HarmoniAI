...
app.include_router(image_to_video_with_audio, prefix="/image-to-video-add-audio", tags=["image-to-video-audio"])
app.include_router(image_to_image_process,prefix="/image-process",tags = ["image-to-image-process"])
app.include_router(audio_generate_router,prefix = "/audio-generate",tags = ["text-to-voice"])
app.include_router(video_to_text_router,prefix = "/video-to-text",tags = ["video-to-text"])
app.include_router(voice_cloning_router,prefix = "/voice-cloning",tags = ["voice-to-voice"])
