...
def image_style_and_color_change(prompt: str, source_image: str, style_image: str):
    try:
        ...
        response,model_info = image_style_enhanche_create_prediction(prompt, source_image, style_image)
...
if __name__ == "__main__":
    ...
    source_image = "https://images.pexels.com/photos/906150/pexels-photo-906150.jpeg?auto=compress&cs=tinysrgb&w=600"
    style_image = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRc7u6bc5fdfAXTebU78knx9Y5n7b9z05MhDA&s"
    prompt =(f"A photo of the reimagined {source_image} in the style of garden")
